  ...
  return (
    ...
    >
      ...
      <div className="absolute top-2 left-2">
        <span className="glass-chip glass-chip-neutral rounded-lg px-2 py-0.5 text-xs font-medium">{globalPanelNumber}</span>
      </div>

      <div className="absolute top-2 right-2">
        <span className="glass-chip glass-chip-info rounded-lg px-2 py-0.5 text-xs">{shotType}</span>
      </div>
